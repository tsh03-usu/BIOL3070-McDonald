...
- [METHODS](#methods)
  - [First Analysis: Barplots of blood meal ID by trap locations
    with/without WNV positive mosquito
    pools](#first-analysis-barplots-of-blood-meal-id-by-trap-locations-withwithout-wnv-positive-mosquito-pools)
...
## First Analysis: Barplots of blood meal ID by trap locations with/without WNV positive mosquito pools
